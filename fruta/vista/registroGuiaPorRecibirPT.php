...
if ($EMPRESAS  && $PLANTAS && $TEMPORADAS) {
    ...
    $ARRAYDESPACHOPT = $DESPACHOPT_ADO->listarDespachoptEmpresaPlantaTemporadaGuiaCBXEstadoDespacho($EMPRESAS, $PLANTAS, $TEMPORADAS);
                                        ...
                                        <table id="despachopt" class="table-hover " style="width: 100%;">
                                            ...
                                            <?php foreach ($ARRAYDESPACHOPT as $r) : ?>
                                                    ...
                                                    if ($r['ESTADO_DESPACHO'] == "2") {
                                                       $ESTADODESPACHO = '<span style="background-color:#e74c3c; color:#fff; padding:4px 8px; border-radius:6px; font-weight:bold;">Por Confirmar</span>';
                                                    }
                                                    if ($r['ESTADO_DESPACHO'] == "3") {
                                                        $ESTADODESPACHO = "Rechazado";
                                                    }
                                                    if ($r['ESTADO_DESPACHO'] == "4") {
                                                        $ESTADODESPACHO = '<span style="background-color:#2ecc71; color:#fff; padding:4px 8px; border-radius:6px; font-weight:bold;">Aprobado</span>';
                                                    }
                                                    if ($r['TDESPACHO'] == "1") {
