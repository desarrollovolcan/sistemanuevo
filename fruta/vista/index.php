                        ...
                        <div class="col-xl-3 col-md-6 col-12 mb-10">
                            <div class="box kpi-card bg-kilos-1 text-white">
                                <div class="box-body">
                                    ...
                                    <h3 class="kpi-number mb-5">
                                        <?php echo number_format(round($kilosMpTotales, 0), 0, ",", "."); ?> kg
                                    </h3>
                                    <p class="kpi-meta mb-0">
                                        <?php echo $empresasConMovimiento; ?> empresas aportando ·
                                        Promedio
                                        <?php echo $empresasConMovimiento > 0 ? number_format(round($kilosMpTotales / $empresasConMovimiento, 0), 0, ",", ".") : 0; ?>
                                        kg
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 col-12 mb-10">
                            <div class="box kpi-card bg-kilos-2 text-white">
                                <div class="box-body">
                                    ...
                                    <h3 class="kpi-number mb-5">
                                        <?php echo number_format(round($acumuladoMp, 0), 0, ",", "."); ?> kg
                                    </h3>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="trend-pill <?php echo $claseTrendRecepcion; ?>">
                                            <?php echo $variacionRecepcion; ?>%
                                        </span>
                                        <span class="kpi-meta">
                                            Día anterior:
                                            <?php echo number_format(round($acumuladoMpDiaAnterior, 0), 0, ",", "."); ?> kg
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 col-12 mb-10">
                            <div class="box kpi-card bg-kilos-3 text-white">
                                <div class="box-body">
                                    ...
                                    <h3 class="kpi-number mb-5">
                                        <?php echo number_format(round($mpProcesado, 0), 0, ",", "."); ?> kg
                                    </h3>
                                    <div class="d-flex align-items-center justify-content-between mb-10">
                                        <span class="trend-pill <?php echo $claseTrendProcesado; ?>">
                                            <?php echo $variacionProcesado; ?>%
                                        </span>
                                        <span class="kpi-meta">
                                            Día anterior:
                                            <?php echo number_format(round($mpProcesadoDiaAnterior, 0), 0, ",", "."); ?> kg
                                        </span>
                                    </div>
                                    <div>
                                        <small class="kpi-meta d-block mb-5">
                                            PT exportación:
                                            <?php echo number_format(round($ptExportacion, 0), 0, ",", "."); ?> kg
                                            (<?php echo $porcentajeExportacion; ?>%)
                                        </small>
                        ...
                        <div class="col-xl-3 col-md-6 col-12 mb-10">
                            <div class="box kpi-card bg-kilos-4 text-white">
                                <div class="box-body">
                                    ...
                                    <h3 class="kpi-number mb-5">
                                        <?php echo number_format(round($TOTAL_EXISTENCIA_MP, 0), 0, ",", "."); ?> kg
                                    </h3>
                                    <?php $porcentajeExistenciaSobreRecepcion = $kilosMpTotales > 0 ? round(($TOTAL_EXISTENCIA_MP * 100) / $kilosMpTotales, 1) : 0; ?>
                                    <p class="kpi-meta mb-10">
                                        Equivale al <?php echo $porcentajeExistenciaSobreRecepcion; ?>% de lo recepcionado
                                    </p>
                                    <div class="progress-lite white">
                                ...
                                <div class="box-body kilos-flow">
                                    <div class="row text-center align-items-center">
                                        <div class="col-md-3 col-6 flow-step mb-15 mb-md-0">
                                            ...
                                            <div class="flow-value text-primary mb-5">
                                                <?php echo number_format(round($kilosMpTotales, 0), 0, ",", "."); ?> kg
                                            </div>
                                        ...
                                        <div class="col-md-3 col-6 flow-step mb-15 mb-md-0">
                                            ...
                                            <div class="flow-value text-success mb-5">
                                                <?php echo number_format(round($mpProcesado, 0), 0, ",", "."); ?> kg
                                            </div>
                                            ...
                                            <small class="text-muted">
                                                Equivale al <?php echo $porcentajeProcesoSobreRecepcion; ?>% de lo recepcionado
                                            </small>
                                        </div>
                                        <div class="col-md-3 col-6 flow-step mb-15 mb-md-0">
                                            <p class="text-muted mb-5">Exportación PT</p>
                                            <div class="flow-value text-info mb-5">
                                                <?php echo number_format(round($ptExportacion, 0), 0, ",", "."); ?> kg
                                            </div>
                                            <div class="progress-lite">
                                            ...
                                            <small class="text-muted">
                                                <?php echo $porcentajeExportacion; ?>% del total procesado
                                            </small>
                                        </div>
                                        <div class="col-md-3 col-6 mb-15 mb-md-0">
                                            <p class="text-muted mb-5">Stock disponible</p>
                                            <div class="flow-value mb-5" style="color:#8b5cf6;">
                                                <?php echo number_format(round($TOTAL_EXISTENCIA_MP, 0), 0, ",", "."); ?> kg
                                            </div>
                                            <div class="progress-lite">
                                            ...
                                            <small class="text-muted">
                                                <?php echo number_format(round($kilosNoProcesados, 0), 0, ",", "."); ?> kg sin procesar aún
                                            </small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 col-12">
                            <div class="box">
                                ...
                                <div class="box-body bg-light py-10 text-center">
                                    <small class="text-muted">
                                        Reembalajes: <?php echo $reembalajesAbiertos; ?> ·
                                        Repaletizajes: <?php echo $repaletizajesAbiertos; ?>
                                    </small>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <?php if ($kilosMpTotalesEmpresaPlanta) : ?>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <?php echo number_format(round($rowsKilosTotalesEmpresaPlanta["TOTAL"], 0), 0, ",", "."); ?> kg
                                                            </td>
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="4" class="text-center text-muted">
                                                            Sin kilos netos registrados para la planta seleccionada.
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php if ($kilosMpProcesadosAgrupado) : ?>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <?php echo number_format(round($rowsProcesoAgrupado["TOTAL"], 0), 0, ",", "."); ?> kg
                                                            </td>
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="4" class="text-center text-muted">
                                                            Sin procesos registrados para la planta seleccionada.
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                                ...
                                                <?php if ($query_existenciaMpEmpresa) : ?>
                                                    <?php foreach ($query_existenciaMpEmpresa as $rowsExistenciaMpEmpresa) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <?php echo number_format(round($rowsExistenciaMpEmpresa["TOTAL"], 0), 0, ",", "."); ?> kg
                                                            </td>
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="3" class="text-center text-muted">
                                                            Sin existencia de materia prima para la planta seleccionada.
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php if ($kilosMpPorVariedad) : ?>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <?php echo number_format(round($rowsVariedad["TOTAL"], 0), 0, ",", "."); ?> kg
                                                            </td>
                                                ...
                                                <?php else : ?>
                                                    <tr>
                                                        <td colspan="4" class="text-center text-muted">
                                                            Sin registros de recepción por variedad para la planta seleccionada.
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                            </tbody>
