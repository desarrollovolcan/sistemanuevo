                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                ...
                                                                                <span href="#" class="dropdown-item">                         
                                                                                    <div class="btn-group btn-block col-12" role="group" aria-label="Acciones generales">  
                                                                                        ...
                                                                                        <?php } ?>
                                                                                        <button type="submit" class="btn btn-success " id="DUPLICAR" name="DUPLICAR" data-toggle="tooltip" title="Duplicar Instructivo Carga">
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        if (isset($_REQUEST['DUPLICAR'])) {
            ...
            if ($ARRAYVERICARGA) {
                ...
                $AUSUARIO_ADO->agregarAusuario2($NUMERO, 3, 1, "" . $_SESSION["NOMBRE_USUARIO"] . ", Duplicación Instructivo Carga", "fruta_icarga", $IDNUEVO, $_SESSION["ID_USUARIO"], $_SESSION['ID_EMPRESA'], 'NULL', $_SESSION['ID_TEMPORADA']);
